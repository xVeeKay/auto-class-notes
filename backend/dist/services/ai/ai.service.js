...
const buildPrompt = (existingSubjects) => {
...
export const analyzeLectureImage = async (imageBuffer, mimeType, existingSubjects) => {
    try {
        ...
        const message = error instanceof Error
            ...
            : "";
        const shouldFallback = message.includes("429") ||
